...
class AlfrescoButton implements \JsonSerializable
{
    ...
    public const CLASSNAME = "org.joget.alfresco.AlfrescoRepoButton";
    public const PROCESSIDDEFAULT = "#assignment.processId#";
    public const IDDEFAULT = "documento";
    public const ETICHETTA = "Apri Documenti";
    private $processId;
